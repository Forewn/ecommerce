    ...
    <table class="table">
        ...
        <tbody id="table">
            ...
            if (isset($_SESSION['usuario'])) {
                ...
                cedula_usuario = (SELECT Cedula FROM usuarios WHERE Usuario = ?) AND pagado = 1");
            ...
            <tr>
              ...
              <td>{$referencia}</td>
              <td>{$total}</td>
              <td><div class='btn btn-success' onclick='window.location.href = `../php/factura.php?id={$id}`'>Opciones</div></td>
            </tr>
            ";
                }
            }
